...
void atg_empty_like(tensor *, tensor self, int options_kind, int options_device);
...
void atg_ones_like(tensor *, tensor self, int options_kind, int options_device);
...
void atg_rand_like(tensor *, tensor self, int options_kind, int options_device);
...
void atg_randint_like(tensor *, tensor self, int64_t high, int options_kind, int options_device);
void atg_randint_like1(tensor *, tensor self, int64_t low, int64_t high, int options_kind, int options_device);
...
void atg_randn_like(tensor *, tensor self, int options_kind, int options_device);
...
void atg_zeros_like(tensor *, tensor self, int options_kind, int options_device);
