...
void atg__test_ambiguous_defaults1(tensor *, tensor dummy, int64_t a, char* b_ptr, int b_len);
...
void atg_clamp_max1(tensor *, tensor self, tensor max);
void atg_clamp_max_(tensor *, tensor self, scalar max);
void atg_clamp_max_1(tensor *, tensor self, tensor max);
void atg_clamp_max_out(tensor *, tensor out, tensor self, scalar max);
void atg_clamp_max_out1(tensor *, tensor out, tensor self, tensor max);
void atg_clamp_min(tensor *, tensor self, scalar min);
void atg_clamp_min1(tensor *, tensor self, tensor min);
void atg_clamp_min_(tensor *, tensor self, scalar min);
void atg_clamp_min_1(tensor *, tensor self, tensor min);
void atg_clamp_min_out(tensor *, tensor out, tensor self, scalar min);
void atg_clamp_min_out1(tensor *, tensor out, tensor self, tensor min);
...
void atg_conv1d1(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char* padding_ptr, int padding_len, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg_conv2d1(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char* padding_ptr, int padding_len, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg_conv3d1(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char* padding_ptr, int padding_len, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg_copysign_out1(tensor *, tensor out, tensor self, scalar other);
...
void atg_div2(tensor *, tensor self, tensor other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_div3(tensor *, tensor self, scalar other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_div_(tensor *, tensor self, tensor other);
void atg_div_1(tensor *, tensor self, scalar other);
void atg_div_2(tensor *, tensor self, tensor other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_div_3(tensor *, tensor self, scalar other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_div_out(tensor *, tensor out, tensor self, tensor other);
void atg_div_out1(tensor *, tensor out, tensor self, tensor other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_divide(tensor *, tensor self, tensor other);
void atg_divide1(tensor *, tensor self, scalar other);
void atg_divide2(tensor *, tensor self, tensor other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_divide3(tensor *, tensor self, scalar other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_divide_(tensor *, tensor self, tensor other);
void atg_divide_1(tensor *, tensor self, scalar other);
void atg_divide_2(tensor *, tensor self, tensor other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_divide_3(tensor *, tensor self, scalar other, char* rounding_mode_ptr, int rounding_mode_len);
void atg_divide_out(tensor *, tensor out, tensor self, tensor other);
void atg_divide_out1(tensor *, tensor out, tensor self, tensor other, char* rounding_mode_ptr, int rounding_mode_len);
...
void atg_embedding_bag1(tensor *, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights, int include_last_offset, int64_t padding_idx_v, uint8_t padding_idx_null);
...
void atg_float_power1(tensor *, scalar self_scalar, tensor exponent);
...
void atg_float_power_out1(tensor *, tensor out, scalar self_scalar, tensor exponent);
...
void atg_index_add1(tensor *, tensor self, int64_t dim, tensor index, tensor source, scalar alpha);
void atg_index_add_(tensor *, tensor self, int64_t dim, tensor index, tensor source);
void atg_index_add_1(tensor *, tensor self, int64_t dim, tensor index, tensor source, scalar alpha);
...
void atg_linalg_cond1(tensor *, tensor self, char* p_ptr, int p_len);
void atg_linalg_cond_out(tensor *, tensor out, tensor self, scalar p);
void atg_linalg_cond_out1(tensor *, tensor out, tensor self, char* p_ptr, int p_len);
...
void atg_linalg_eigh_out(tensor *, tensor eigvals, tensor eigvecs, tensor self, char* UPLO_ptr, int UPLO_len);
...
void atg_linalg_matrix_norm1(tensor *, tensor self, char* ord_ptr, int ord_len, int64_t *dim_data, int dim_len, int keepdim, int dtype);
...
void atg_linalg_matrix_norm_out1(tensor *, tensor out, tensor self, char* ord_ptr, int ord_len, int64_t *dim_data, int dim_len, int keepdim, int dtype);
...
void atg_nanquantile2(tensor *, tensor self, double q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_nanquantile3(tensor *, tensor self, tensor q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
...
void atg_nanquantile_out2(tensor *, tensor out, tensor self, double q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_nanquantile_out3(tensor *, tensor out, tensor self, tensor q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
...
void atg_pow_out1(tensor *, tensor out, scalar self_scalar, tensor exponent);
...
void atg_quantile2(tensor *, tensor self, double q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_quantile3(tensor *, tensor self, tensor q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
...
void atg_quantile_out2(tensor *, tensor out, tensor self, double q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_quantile_out3(tensor *, tensor out, tensor self, tensor q, int64_t dim_v, uint8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
...
void atg_special_xlog1py1(tensor *, scalar self_scalar, tensor other);
void atg_special_xlog1py2(tensor *, tensor self, scalar other);
void atg_special_xlog1py_out(tensor *, tensor out, tensor self, tensor other);
void atg_special_xlog1py_out1(tensor *, tensor out, scalar self_scalar, tensor other);
void atg_special_xlog1py_out2(tensor *, tensor out, tensor self, scalar other);
...
void atg_std2(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, uint8_t correction_null, int keepdim);
...
void atg_std_mean2(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, uint8_t correction_null, int keepdim);
void atg_std_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int unbiased, int keepdim);
void atg_std_out1(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, uint8_t correction_null, int keepdim);
...
void atg_threshold_backward_out(tensor *, tensor grad_input, tensor grad_output, tensor self, scalar threshold);
...
void atg_var2(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, uint8_t correction_null, int keepdim);
...
void atg_var_mean2(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, uint8_t correction_null, int keepdim);
void atg_var_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int unbiased, int keepdim);
void atg_var_out1(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, uint8_t correction_null, int keepdim);
...
void atg_xlogy1(tensor *, scalar self_scalar, tensor other);
...
void atg_xlogy_out1(tensor *, tensor out, scalar self_scalar, tensor other);
