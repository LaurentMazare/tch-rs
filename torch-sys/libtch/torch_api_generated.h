...
void atg__addmm(tensor *, tensor self, tensor mat1, tensor mat2);
void atg__addmm_(tensor *, tensor self, tensor mat1, tensor mat2);
void atg__addmm_out(tensor *, tensor out, tensor self, tensor mat1, tensor mat2);
...
void atg__dequantize_linear(tensor *, tensor self, double scale, int64_t zero_point, int dtype);
void atg__dim_arange(tensor *, tensor like, int64_t dim);
void atg__dirichlet_grad(tensor *, tensor x, tensor alpha, tensor total);
void atg__embedding_bag(tensor *, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights);
...
void atg__nnpack_spatial_convolution(tensor *, tensor input, tensor weight, tensor bias, int64_t *padding_data, int padding_len);
...
void atg__per_tensor_affine_qtensor(tensor *, tensor self, double scale, int64_t zero_point);
...
void atg__sparse_add_out(tensor *, tensor out, tensor self, tensor other);
...
void atg__sparse_dense_add_out(tensor *, tensor out, tensor self, tensor other);
void atg__sparse_div_scalar_out(tensor *, tensor out, tensor self, scalar other);
void atg__sparse_div_zerodim_out(tensor *, tensor out, tensor self, tensor other);
void atg__sparse_mm(tensor *, tensor sparse, tensor dense);
void atg__sparse_mul_out(tensor *, tensor out, tensor self, tensor other);
void atg__sparse_mul_scalar_out(tensor *, tensor out, tensor self, scalar other);
void atg__sparse_mul_zerodim_out(tensor *, tensor out, tensor self, tensor other);
