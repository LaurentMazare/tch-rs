...
impl Tensor {
    ...
    pub fn f_internal_and_<S: Into<Scalar>>(
        ...
        unsafe_torch_err!({
            atg___and__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
    ...
    pub fn f_internal_and_1(
        &mut self, other: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___and__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_iand_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___iand__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_iand_1(
        &mut self, other: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___iand__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_ilshift_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___ilshift__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_ilshift_1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___ilshift__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_ior_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___ior__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_ior_1(
        &mut self, other: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___ior__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_irshift_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___irshift__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_irshift_1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___irshift__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_ixor_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___ixor__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_ixor_1(
        &mut self, other: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___ixor__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_lshift_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___lshift__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_lshift_1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___lshift__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_or_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___or__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_or_1(
        &mut self, other: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___or__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_rshift_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___rshift__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_rshift_1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___rshift__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_xor_<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___xor__(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.into().c_scalar
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_xor_1(
        &mut self, other: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg___xor__1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                other.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_adaptive_avg_pool2d(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__adaptive_avg_pool2d(c_tensors.as_mut_ptr(),
                self.c_tensor,
    ...
    pub fn f_internal_adaptive_avg_pool2d_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__adaptive_avg_pool2d_backward(c_tensors.as_mut_ptr(),
    ...
    pub fn f_internal_baddbmm_mkl_(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__baddbmm_mkl_(c_tensors.as_mut_ptr(),
                self.c_tensor,
                batch1.c_tensor,
                batch2.c_tensor
            ) });
    ...
    pub fn f_internal_cast_byte(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_byte(c_tensors.as_mut_ptr(),
                self.c_tensor,
    ...
    pub fn f_internal_cast_char(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_char(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cast_double(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_double(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cast_float(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_float(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cast_half(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_half(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cast_int(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_int(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cast_long(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_long(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cast_short(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cast_short(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cdist_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cdist_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                x1.c_tensor,
                x2.c_tensor,
                p,
    ...
    pub fn f_internal_cholesky_helper(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cholesky_helper(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if upper { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_cholesky_solve_helper(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cholesky_solve_helper(c_tensors.as_mut_ptr(),
                self.c_tensor,
                a.c_tensor,
                if upper { 1 } else { 0 }
            ) });
    ...
    pub fn f_internal_coalesced_(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__coalesced_(c_tensors.as_mut_ptr(),
                self.c_tensor,
    ...
    pub fn f_internal_convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: &[i64], padding: &[i64], dilation: &[i64], transposed: bool, output_padding: &[i64], groups: i64, benchmark: bool, deterministic: bool, cudnn_enabled: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__convolution(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.c_tensor,
    ...
    pub fn f_internal_convolution_nogroup<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: &[i64], padding: &[i64], dilation: &[i64], transposed: bool, output_padding: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__convolution_nogroup(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.c_tensor,
                bias.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                stride.as_ptr(), stride.len() as i32,
    ...
    pub fn f_internal_ctc_loss(
        ...
        unsafe_torch_err!({
            atg__ctc_loss(c_tensors.as_mut_ptr(),
                log_probs.c_tensor,
                targets.c_tensor,
    ...
    pub fn f_internal_ctc_loss_backward(
        grad: &Tensor, log_probs: &Tensor, targets: &Tensor, input_lengths: &[i64], target_lengths: &[i64], neg_log_likelihood: &Tensor, log_alpha: &Tensor, blank: i64, zero_infinity: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__ctc_loss_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                log_probs.c_tensor,
                targets.c_tensor,
                input_lengths.as_ptr(), input_lengths.len() as i32,
    ...
    pub fn f_internal_cudnn_ctc_loss(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__cudnn_ctc_loss(c_tensors.as_mut_ptr(),
                log_probs.c_tensor,
                targets.c_tensor,
                input_lengths.as_ptr(), input_lengths.len() as i32,
                target_lengths.as_ptr(), target_lengths.len() as i32,
    ...
    pub fn f_internal_cudnn_init_dropout_state(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cudnn_init_dropout_state(c_tensors.as_mut_ptr(),
                dropout,
                if train { 1 } else { 0 },
                dropout_seed,
    ...
    pub fn f_internal_cudnn_rnn<T: Borrow<Tensor>>(
        &self, weight: &[T], weight_stride0: i64, weight_buf: Option<T>, hx: &Tensor, cx: Option<T>, mode: i64, hidden_size: i64, num_layers: i64, batch_first: bool, dropout: f64, train: bool, bidirectional: bool, batch_sizes: &[i64], dropout_state: Option<T>
    ) -> failure::Fallible<(Tensor, Tensor, Tensor, Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 5];
        unsafe_torch_err!({
            atg__cudnn_rnn(c_tensors.as_mut_ptr(),
                self.c_tensor,
                ptr_list(weight).as_ptr(), weight.len() as i32,
                weight_stride0,
                ...
                batch_sizes.as_ptr(), batch_sizes.len() as i32,
                dropout_state.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor)
            ) });
        Ok((Tensor { c_tensor: c_tensors[0] }, Tensor { c_tensor: c_tensors[1] }, Tensor { c_tensor: c_tensors[2] }, Tensor { c_tensor: c_tensors[3] }, Tensor { c_tensor: c_tensors[4] }))
    }

    pub fn f_internal_cudnn_rnn_flatten_weight<T: Borrow<Tensor>>(
        weight_arr: &[T], weight_stride0: i64, input_size: i64, mode: i64, hidden_size: i64, num_layers: i64, batch_first: bool, bidirectional: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__cudnn_rnn_flatten_weight(c_tensors.as_mut_ptr(),
                ptr_list(weight_arr).as_ptr(), weight_arr.len() as i32,
                weight_stride0,
                input_size,
                mode,
                hidden_size,
    ...
    pub fn f_internal_dim_arange(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__dim_arange(c_tensors.as_mut_ptr(),
                like.c_tensor,
                dim
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_dirichlet_grad(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__dirichlet_grad(c_tensors.as_mut_ptr(),
                x.c_tensor,
                alpha.c_tensor,
                total.c_tensor
            ) });
    ...
    pub fn f_internal_dirichlet_grad_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__dirichlet_grad_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                x.c_tensor,
                alpha.c_tensor,
                total.c_tensor
    ...
    pub fn f_internal_embedding_bag<T: Borrow<Tensor>>(
        weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>
    ) -> failure::Fallible<(Tensor, Tensor, Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 4];
        unsafe_torch_err!({
            atg__embedding_bag(c_tensors.as_mut_ptr(),
                weight.c_tensor,
                indices.c_tensor,
                offsets.c_tensor,
    ...
    pub fn f_internal_embedding_bag_backward<T: Borrow<Tensor>>(
        grad: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, maximum_indices: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__embedding_bag_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                indices.c_tensor,
                offsets.c_tensor,
                offset2bag.c_tensor,
    ...
    pub fn f_internal_embedding_bag_dense_backward<T: Borrow<Tensor>>(
        grad: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, maximum_indices: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, per_sample_weights: Option<T>
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__embedding_bag_dense_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                indices.c_tensor,
                offsets.c_tensor,
                offset2bag.c_tensor,
    ...
    pub fn f_internal_embedding_bag_per_sample_weights_backward(
        grad: &Tensor, weight: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, mode: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__embedding_bag_per_sample_weights_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                weight.c_tensor,
                indices.c_tensor,
                offsets.c_tensor,
    ...
    pub fn f_internal_embedding_bag_sparse_backward<T: Borrow<Tensor>>(
        grad: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, per_sample_weights: Option<T>
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__embedding_bag_sparse_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                indices.c_tensor,
                offsets.c_tensor,
                offset2bag.c_tensor,
    ...
    pub fn f_internal_empty_affine_quantized(
        size: &[i64], options: (Kind, Device), scale: f64, zero_point: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__empty_affine_quantized(c_tensors.as_mut_ptr(),
    ...
    pub fn f_internal_fft_with_size(
        &self, signal_ndim: i64, complex_input: bool, complex_output: bool, inverse: bool, checked_signal_sizes: &[i64], normalized: bool, onesided: bool, output_sizes: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__fft_with_size(c_tensors.as_mut_ptr(),
                self.c_tensor,
                signal_ndim,
                if complex_input { 1 } else { 0 },
                if complex_output { 1 } else { 0 },
                if inverse { 1 } else { 0 },
                checked_signal_sizes.as_ptr(), checked_signal_sizes.len() as i32,
                if normalized { 1 } else { 0 },
                if onesided { 1 } else { 0 },
                output_sizes.as_ptr(), output_sizes.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_internal_fused_dropout(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__fused_dropout(c_tensors.as_mut_ptr(),
                self.c_tensor,
                p
            ) });
        Ok((Tensor { c_tensor: c_tensors[0] }, Tensor { c_tensor: c_tensors[1] }))
    ...
    pub fn f_internal_gather_sparse_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__gather_sparse_backward(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                grad.c_tensor
    ...
    pub fn f_internal_indices(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__indices(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }

    pub fn f_internal_inverse_helper(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__inverse_helper(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_internal_log_softmax(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__log_softmax(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
    ...
    pub fn f_internal_log_softmax_backward_data(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__log_softmax_backward_data(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                output.c_tensor,
                dim,
                self.c_tensor
    ...
    pub fn f_internal_lu_with_info(
        ...
        unsafe_torch_err!({
            atg__lu_with_info(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if pivot { 1 } else { 0 },
    ...
    pub fn f_internal_masked_scale(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__masked_scale(c_tensors.as_mut_ptr(),
                self.c_tensor,
                mask.c_tensor,
                scale
            ) });
    ...
    pub fn f_internal_multinomial_alias_draw(
        j: &Tensor, q: &Tensor, num_samples: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__multinomial_alias_draw(c_tensors.as_mut_ptr(),
                j.c_tensor,
                q.c_tensor,
                num_samples
            ) });
    ...
    pub fn f_internal_multinomial_alias_setup(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__multinomial_alias_setup(c_tensors.as_mut_ptr(),
                probs.c_tensor
            ) });
        Ok((Tensor { c_tensor: c_tensors[0] }, Tensor { c_tensor: c_tensors[1] }))
    }
    ...
    pub fn f_internal_nnpack_spatial_convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, padding: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__nnpack_spatial_convolution(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.c_tensor,
                bias.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                padding.as_ptr(), padding.len() as i32
    ...
    pub fn f_internal_nnpack_spatial_convolution_backward_input(
        &self, grad_output: &Tensor, weight: &Tensor, padding: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__nnpack_spatial_convolution_backward_input(c_tensors.as_mut_ptr(),
                self.c_tensor,
                grad_output.c_tensor,
                weight.c_tensor,
                padding.as_ptr(), padding.len() as i32
    ...
    pub fn f_internal_nnpack_spatial_convolution_backward_weight(
        &self, weightsize: &[i64], grad_output: &Tensor, padding: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__nnpack_spatial_convolution_backward_weight(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weightsize.as_ptr(), weightsize.len() as i32,
                grad_output.c_tensor,
                padding.as_ptr(), padding.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_pack_padded_sequence(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__pack_padded_sequence(c_tensors.as_mut_ptr(),
                self.c_tensor,
                lengths.c_tensor,
                if batch_first { 1 } else { 0 }
            ) });
    ...
    pub fn f_internal_pack_padded_sequence_backward(
        grad: &Tensor, input_size: &[i64], batch_sizes: &Tensor, batch_first: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__pack_padded_sequence_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
    ...
    pub fn f_internal_pad_packed_sequence<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__pad_packed_sequence(c_tensors.as_mut_ptr(),
                data.c_tensor,
                batch_sizes.c_tensor,
                if batch_first { 1 } else { 0 },
    ...
    pub fn f_internal_pdist_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__pdist_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                self.c_tensor,
                p,
                pdist.c_tensor
    ...
    pub fn f_internal_reshape_from_tensor(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__reshape_from_tensor(c_tensors.as_mut_ptr(),
                self.c_tensor,
                shape.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_s_copy_from(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__s_copy_from(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dst.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
    ...
    pub fn f_internal_s_where(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__s_where(c_tensors.as_mut_ptr(),
                condition.c_tensor,
                self.c_tensor,
                other.c_tensor
            ) });
    ...
    pub fn f_internal_sample_dirichlet(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sample_dirichlet(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }

    pub fn f_internal_shape_as_tensor(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__shape_as_tensor(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_internal_sobol_engine_draw(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__sobol_engine_draw(c_tensors.as_mut_ptr(),
                quasi.c_tensor,
                n,
                sobolstate.c_tensor,
                dimension,
    ...
    pub fn f_internal_sobol_engine_ff_(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sobol_engine_ff_(c_tensors.as_mut_ptr(),
                self.c_tensor,
                n,
                sobolstate.c_tensor,
                dimension,
    ...
    pub fn f_internal_sobol_engine_initialize_state_(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sobol_engine_initialize_state_(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dimension
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_sobol_engine_scramble_(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sobol_engine_scramble_(c_tensors.as_mut_ptr(),
                self.c_tensor,
                ltm.c_tensor,
                dimension
            ) });
    ...
    pub fn f_internal_softmax(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__softmax(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                if half_to_float { 1 } else { 0 }
            ) });
    ...
    pub fn f_internal_softmax_backward_data(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__softmax_backward_data(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                output.c_tensor,
                dim,
                self.c_tensor
    ...
    pub fn f_internal_solve_helper(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__solve_helper(c_tensors.as_mut_ptr(),
                self.c_tensor,
                a.c_tensor
            ) });
        Ok((Tensor { c_tensor: c_tensors[0] }, Tensor { c_tensor: c_tensors[1] }))
    ...
    pub fn f_internal_sparse_add_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_add_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                other.c_tensor
            ) });
    ...
    pub fn f_internal_sparse_addmm(
        &self, sparse: &Tensor, dense: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_addmm(c_tensors.as_mut_ptr(),
                self.c_tensor,
                sparse.c_tensor,
                dense.c_tensor
            ) });
    ...
    pub fn f_internal_sparse_coo_tensor_unsafe(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_coo_tensor_unsafe(c_tensors.as_mut_ptr(),
                indices.c_tensor,
                values.c_tensor,
                size.as_ptr(), size.len() as i32,
                options.0.c_int(), options.1.c_int()
    ...
    pub fn f_internal_sparse_coo_tensor_with_dims(
        sparse_dim: i64, dense_dim: i64, size: &[i64], options: (Kind, Device)
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_coo_tensor_with_dims(c_tensors.as_mut_ptr(),
                sparse_dim,
                dense_dim,
                size.as_ptr(), size.len() as i32,
                options.0.c_int(), options.1.c_int()
    ...
    pub fn f_internal_sparse_coo_tensor_with_dims_and_tensors(
        sparse_dim: i64, dense_dim: i64, size: &[i64], indices: &Tensor, values: &Tensor, options: (Kind, Device)
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_coo_tensor_with_dims_and_tensors(c_tensors.as_mut_ptr(),
                sparse_dim,
                dense_dim,
                size.as_ptr(), size.len() as i32,
                indices.c_tensor,
    ...
    pub fn f_internal_sparse_div_scalar_out<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_div_scalar_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                other.into().c_scalar
            ) });
    ...
    pub fn f_internal_sparse_div_zerodim_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_div_zerodim_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                other.c_tensor
            ) });
    ...
    pub fn f_internal_sparse_mm(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_mm(c_tensors.as_mut_ptr(),
                sparse.c_tensor,
                dense.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_sparse_mul_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_mul_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                other.c_tensor
            ) });
    ...
    pub fn f_internal_sparse_mul_scalar_out<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_mul_scalar_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                other.into().c_scalar
            ) });
    ...
    pub fn f_internal_sparse_mul_zerodim_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_mul_zerodim_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                other.c_tensor
            ) });
    ...
    pub fn f_internal_sparse_sum(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_sum(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }

    pub fn f_internal_sparse_sum1(
        &self, dtype: Kind
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_sum1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dtype.c_int()
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_sparse_sum2(
        &self, dim: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_sum2(c_tensors.as_mut_ptr(),
                self.c_tensor,
    ...
    pub fn f_internal_sparse_sum3(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_sum3(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim.as_ptr(), dim.len() as i32,
                dtype.c_int()
            ) });
    ...
    pub fn f_internal_sparse_sum_backward(
        &self, grad: &Tensor, dim: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__sparse_sum_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                self.c_tensor,
                dim.as_ptr(), dim.len() as i32
            ) });
    ...
    pub fn f_internal_standard_gamma(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__standard_gamma(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_internal_standard_gamma_grad(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__standard_gamma_grad(c_tensors.as_mut_ptr(),
                self.c_tensor,
                output.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_triangular_solve_helper(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__triangular_solve_helper(c_tensors.as_mut_ptr(),
                self.c_tensor,
                a.c_tensor,
                if upper { 1 } else { 0 },
    ...
    pub fn f_internal_trilinear(
        i1: &Tensor, i2: &Tensor, i3: &Tensor, expand1: &[i64], expand2: &[i64], expand3: &[i64], sumdim: &[i64], unroll_dim: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__trilinear(c_tensors.as_mut_ptr(),
                i1.c_tensor,
                i2.c_tensor,
                i3.c_tensor,
                expand1.as_ptr(), expand1.len() as i32,
                expand2.as_ptr(), expand2.len() as i32,
                expand3.as_ptr(), expand3.len() as i32,
                sumdim.as_ptr(), sumdim.len() as i32,
                unroll_dim
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_internal_unique(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__unique(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if sorted { 1 } else { 0 },
    ...
    pub fn f_internal_unique2(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 3];
        unsafe_torch_err!({
            atg__unique2(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if sorted { 1 } else { 0 },
                if return_inverse { 1 } else { 0 },
    ...
    pub fn f_internal_unsafe_view(
        &self, size: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__unsafe_view(c_tensors.as_mut_ptr(),
                self.c_tensor,
                size.as_ptr(), size.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_internal_values(
        &self, 
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__values(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_internal_weight_norm(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg__weight_norm(c_tensors.as_mut_ptr(),
                v.c_tensor,
                g.c_tensor,
                dim
            ) });
    ...
    pub fn f_internal_weight_norm_cuda_interface(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__weight_norm_cuda_interface(c_tensors.as_mut_ptr(),
                v.c_tensor,
                g.c_tensor,
                dim
            ) });
    ...
    pub fn f_internal_weight_norm_cuda_interface_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__weight_norm_cuda_interface_backward(c_tensors.as_mut_ptr(),
                grad_w.c_tensor,
                saved_v.c_tensor,
                saved_g.c_tensor,
    ...
    pub fn f_internal_weight_norm_differentiable_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg__weight_norm_differentiable_backward(c_tensors.as_mut_ptr(),
                grad_w.c_tensor,
                saved_v.c_tensor,
                saved_g.c_tensor,
                saved_norms.c_tensor,
    ...
    pub fn f_adaptive_avg_pool2d_out(
        &self, out: &Tensor, output_size: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_adaptive_max_pool2d_out(
        &self, out: &Tensor, indices: &Tensor, output_size: &[i64]
    ) -> failure::Fallible<(Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
    ...
    pub fn f_affine_grid_generator(
        theta: &Tensor, size: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_affine_grid_generator(c_tensors.as_mut_ptr(),
                theta.c_tensor,
                size.as_ptr(), size.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_affine_grid_generator_backward(
        grad: &Tensor, size: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_affine_grid_generator_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                size.as_ptr(), size.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_argsort(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_argsort(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
    ...
    pub fn f_as_strided_(
        &mut self, size: &[i64], stride: &[i64], storage_offset: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_avg_pool2d_out(
        &self, out: &Tensor, kernel_size: &[i64], stride: &[i64], padding: &[i64], ceil_mode: bool, count_include_pad: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_batch_norm_backward_elemt<T: Borrow<Tensor>>(
        &self, grad_out: &Tensor, mean: &Tensor, invstd: &Tensor, weight: Option<T>, mean_dy: &Tensor, mean_dy_xmu: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_batch_norm_backward_elemt(c_tensors.as_mut_ptr(),
                grad_out.c_tensor,
                self.c_tensor,
                mean.c_tensor,
                invstd.c_tensor,
    ...
    pub fn f_batch_norm_backward_reduce(
        &self, grad_out: &Tensor, mean: &Tensor, invstd: &Tensor, input_g: bool, weight_g: bool, bias_g: bool
    ) -> failure::Fallible<(Tensor, Tensor, Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 4];
        unsafe_torch_err!({
            atg_batch_norm_backward_reduce(c_tensors.as_mut_ptr(),
                grad_out.c_tensor,
                self.c_tensor,
                mean.c_tensor,
                invstd.c_tensor,
    ...
    pub fn f_batch_norm_elemt<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_batch_norm_elemt(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                bias.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                mean.c_tensor,
    ...
    pub fn f_batch_norm_gather_stats<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_batch_norm_gather_stats(c_tensors.as_mut_ptr(),
                self.c_tensor,
                mean.c_tensor,
                invstd.c_tensor,
                running_mean.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
    ...
    pub fn f_batch_norm_stats(
        &self, eps: f64
    ) -> failure::Fallible<(Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_batch_norm_stats(c_tensors.as_mut_ptr(),
                self.c_tensor,
                eps
            ) });
        Ok((Tensor { c_tensor: c_tensors[0] }, Tensor { c_tensor: c_tensors[1] }))
    ...
    pub fn f_batch_norm_update_stats<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_batch_norm_update_stats(c_tensors.as_mut_ptr(),
                self.c_tensor,
                running_mean.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                running_var.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                momentum
    ...
    pub fn f_cartesian_prod<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cartesian_prod(c_tensors.as_mut_ptr(),
                ptr_list(tensors).as_ptr(), tensors.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_cdist(
        x1: &Tensor, x2: &Tensor, p: f64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cdist(c_tensors.as_mut_ptr(),
                x1.c_tensor,
                x2.c_tensor,
                p
            ) });
    ...
    pub fn f_cholesky_inverse(
        &self, upper: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cholesky_inverse(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if upper { 1 } else { 0 }
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_cholesky_inverse_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cholesky_inverse_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                if upper { 1 } else { 0 }
            ) });
    ...
    pub fn f_cholesky_solve(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cholesky_solve(c_tensors.as_mut_ptr(),
                self.c_tensor,
                input2.c_tensor,
                if upper { 1 } else { 0 }
            ) });
    ...
    pub fn f_cholesky_solve_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cholesky_solve_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                input2.c_tensor,
                if upper { 1 } else { 0 }
    ...
    pub fn f_combinations(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_combinations(c_tensors.as_mut_ptr(),
                self.c_tensor,
                r,
    ...
    pub fn f_conv1d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: &[i64], padding: &[i64], dilation: &[i64], groups: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_conv_transpose1d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: &[i64], padding: &[i64], output_padding: &[i64], groups: i64, dilation: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_cosine_similarity(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_cosine_similarity(c_tensors.as_mut_ptr(),
                x1.c_tensor,
                x2.c_tensor,
                dim,
                eps
    ...
    pub fn f_cumprod_out1(
        &self, out: &Tensor, dim: i64, dtype: Kind
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_dequantize(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_dequantize(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_elu_backward<S: Into<Scalar>>(
        grad_output: &Tensor, alpha: S, scale: S, input_scale: S, output: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_elu_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                alpha.into().c_scalar,
                scale.into().c_scalar,
    ...
    pub fn f_elu_backward_out<S: Into<Scalar>>(
        grad_input: &Tensor, grad_output: &Tensor, alpha: S, scale: S, input_scale: S, output: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_elu_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                alpha.into().c_scalar,
                scale.into().c_scalar,
    ...
    pub fn f_fbgemm_linear_int8_weight<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_fbgemm_linear_int8_weight(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.c_tensor,
                packed.c_tensor,
    ...
    pub fn f_fbgemm_pack_quantized_matrix(
        &self, k: i64, n: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_fbgemm_pack_quantized_matrix(c_tensors.as_mut_ptr(),
                self.c_tensor,
                k,
                n
            ) });
    ...
    pub fn f_fractional_max_pool3d(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_fractional_max_pool3d(c_tensors.as_mut_ptr(),
                self.c_tensor,
                kernel_size.as_ptr(), kernel_size.len() as i32,
                output_size.as_ptr(), output_size.len() as i32,
                random_samples.c_tensor
    ...
    pub fn f_fractional_max_pool3d_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_fractional_max_pool3d_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
                kernel_size.as_ptr(), kernel_size.len() as i32,
                output_size.as_ptr(), output_size.len() as i32,
    ...
    pub fn f_fractional_max_pool3d_backward_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_fractional_max_pool3d_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                kernel_size.as_ptr(), kernel_size.len() as i32,
    ...
    pub fn f_fractional_max_pool3d_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_fractional_max_pool3d_out(c_tensors.as_mut_ptr(),
                output.c_tensor,
                indices.c_tensor,
                self.c_tensor,
                kernel_size.as_ptr(), kernel_size.len() as i32,
    ...
    pub fn f_full_out<S: Into<Scalar>>(
        out: &Tensor, size: &[i64], fill_value: S
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_hardtanh_backward<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_hardtanh_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
    ...
    pub fn f_hardtanh_backward_out<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_hardtanh_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                min_val.into().c_scalar,
    ...
    pub fn f_index_add(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_index_add(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                source.c_tensor
    ...
    pub fn f_index_copy(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_index_copy(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                source.c_tensor
    ...
    pub fn f_index_fill<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_index_fill(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                value.into().c_scalar
    ...
    pub fn f_index_fill1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_index_fill1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                value.c_tensor
    ...
    pub fn f_index_put<T: Borrow<Tensor>>(
        &self, indices: &[T], values: &Tensor, accumulate: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_index_put_<T: Borrow<Tensor>>(
        &mut self, indices: &[T], values: &Tensor, accumulate: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_int_repr(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_int_repr(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_isnan(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_isnan(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_leaky_relu_backward<S: Into<Scalar>>(
        &self, grad_output: &Tensor, negative_slope: S
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_leaky_relu_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
    ...
    pub fn f_leaky_relu_backward_out<S: Into<Scalar>>(
        &self, grad_input: &Tensor, grad_output: &Tensor, negative_slope: S
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_leaky_relu_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                negative_slope.into().c_scalar
    ...
    pub fn f_lerp1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_lerp1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                end.c_tensor,
                weight.c_tensor
            ) });
    ...
    pub fn f_lerp_1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_lerp_1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                end.c_tensor,
                weight.c_tensor
            ) });
    ...
    pub fn f_lerp_out1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_lerp_out1(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                end.c_tensor,
                weight.c_tensor
    ...
    pub fn f_lu_solve(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_lu_solve(c_tensors.as_mut_ptr(),
                self.c_tensor,
                lu_data.c_tensor,
                lu_pivots.c_tensor
            ) });
    ...
    pub fn f_lu_solve_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_lu_solve_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                lu_data.c_tensor,
                lu_pivots.c_tensor
    ...
    pub fn f_masked_fill<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_masked_fill(c_tensors.as_mut_ptr(),
                self.c_tensor,
                mask.c_tensor,
                value.into().c_scalar
            ) });
    ...
    pub fn f_masked_fill1(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_masked_fill1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                mask.c_tensor,
                value.c_tensor
            ) });
    ...
    pub fn f_masked_scatter(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_masked_scatter(c_tensors.as_mut_ptr(),
                self.c_tensor,
                mask.c_tensor,
                source.c_tensor
            ) });
    ...
    pub fn f_max_unpool3d_out(
        &self, out: &Tensor, indices: &Tensor, output_size: &[i64], stride: &[i64], padding: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_mean_out2(
        &self, out: &Tensor, dim: &[i64], keepdim: bool, dtype: Kind
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_miopen_depthwise_convolution<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_miopen_depthwise_convolution(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.c_tensor,
                bias.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor),
                padding.as_ptr(), padding.len() as i32,
    ...
    pub fn f_miopen_depthwise_convolution_backward_input(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_miopen_depthwise_convolution_backward_input(c_tensors.as_mut_ptr(),
                self_size.as_ptr(), self_size.len() as i32,
                grad_output.c_tensor,
                weight.c_tensor,
                padding.as_ptr(), padding.len() as i32,
    ...
    pub fn f_miopen_depthwise_convolution_backward_weight(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_miopen_depthwise_convolution_backward_weight(c_tensors.as_mut_ptr(),
                weight_size.as_ptr(), weight_size.len() as i32,
                grad_output.c_tensor,
                self.c_tensor,
                padding.as_ptr(), padding.len() as i32,
    ...
    pub fn f_mkldnn_linear<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_mkldnn_linear(c_tensors.as_mut_ptr(),
                self.c_tensor,
                weight.c_tensor,
                bias.map_or(std::ptr::null_mut(), |t| t.borrow().c_tensor)
            ) });
    ...
    pub fn f_mkldnn_max_pool2d(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_mkldnn_max_pool2d(c_tensors.as_mut_ptr(),
                self.c_tensor,
                kernel_size.as_ptr(), kernel_size.len() as i32,
                stride.as_ptr(), stride.len() as i32,
                padding.as_ptr(), padding.len() as i32,
    ...
    pub fn f_mkldnn_reorder_conv2d_weight(
        &self, padding: &[i64], stride: &[i64], dilation: &[i64], groups: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_mkldnn_reorder_conv2d_weight(c_tensors.as_mut_ptr(),
                self.c_tensor,
                padding.as_ptr(), padding.len() as i32,
                stride.as_ptr(), stride.len() as i32,
                dilation.as_ptr(), dilation.len() as i32,
    ...
    pub fn f_mkldnn_reshape(
        &self, shape: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_mkldnn_reshape(c_tensors.as_mut_ptr(),
                self.c_tensor,
    ...
    pub fn f_multi_margin_loss_backward<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_multi_margin_loss_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
                target.c_tensor,
                p.into().c_scalar,
    ...
    pub fn f_multi_margin_loss_backward_out<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_multi_margin_loss_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                target.c_tensor,
    ...
    pub fn f_norm2<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_norm2(c_tensors.as_mut_ptr(),
                self.c_tensor,
                p.into().c_scalar,
                dim.as_ptr(), dim.len() as i32,
                if keepdim { 1 } else { 0 }
    ...
    pub fn f_norm3<S: Into<Scalar>>(
        &self, p: S, dim: &[i64], keepdim: bool, dtype: Kind
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_norm3(c_tensors.as_mut_ptr(),
                self.c_tensor,
                p.into().c_scalar,
                dim.as_ptr(), dim.len() as i32,
                if keepdim { 1 } else { 0 },
    ...
    pub fn f_norm_out<S: Into<Scalar>>(
        &self, out: &Tensor, p: S, dim: &[i64], keepdim: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_norm_out1<S: Into<Scalar>>(
        &self, out: &Tensor, p: S, dim: &[i64], keepdim: bool, dtype: Kind
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_norm_out1(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                p.into().c_scalar,
                dim.as_ptr(), dim.len() as i32,
    ...
    pub fn f_normal_out(
        out: &Tensor, mean: &Tensor, std: f64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_normal_out1(
        out: &Tensor, mean: f64, std: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_normal_out2(
        out: &Tensor, mean: &Tensor, std: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_one_hot(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_one_hot(c_tensors.as_mut_ptr(),
                self.c_tensor,
                num_classes
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_pstrf_out(
        &self, u: &Tensor, pivot: &Tensor, upper: bool
    ) -> failure::Fallible<(Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
    ...
    pub fn f_quantize_linear(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_quantize_linear(c_tensors.as_mut_ptr(),
                self.c_tensor,
                scale,
                zero_point
            ) });
    ...
    pub fn f_quantized_gru_cell<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_quantized_gru_cell(c_tensors.as_mut_ptr(),
                self.c_tensor,
                hx.c_tensor,
                w_ih.c_tensor,
                w_hh.c_tensor,
    ...
    pub fn f_quantized_lstm<T: Borrow<Tensor>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 3];
        unsafe_torch_err!({
            atg_quantized_lstm(c_tensors.as_mut_ptr(),
                self.c_tensor,
                ptr_list(hx).as_ptr(), hx.len() as i32,
                ptr_list(params).as_ptr(), params.len() as i32,
                if has_biases { 1 } else { 0 },
    ...
    pub fn f_quantized_lstm_cell<T: Borrow<Tensor>, S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_quantized_lstm_cell(c_tensors.as_mut_ptr(),
                self.c_tensor,
                ptr_list(hx).as_ptr(), hx.len() as i32,
                w_ih.c_tensor,
                w_hh.c_tensor,
    ...
    pub fn f_quantized_rnn_relu_cell<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_quantized_rnn_relu_cell(c_tensors.as_mut_ptr(),
                self.c_tensor,
                hx.c_tensor,
                w_ih.c_tensor,
                w_hh.c_tensor,
    ...
    pub fn f_quantized_rnn_tanh_cell<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_quantized_rnn_tanh_cell(c_tensors.as_mut_ptr(),
                self.c_tensor,
                hx.c_tensor,
                w_ih.c_tensor,
                w_hh.c_tensor,
    ...
    pub fn f_randint_out1(
        out: &Tensor, low: i64, high: i64, size: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_repeat_interleave(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_repeat_interleave(c_tensors.as_mut_ptr(),
                repeats.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }
    ...
    pub fn f_repeat_interleave1(
        &self, repeats: &Tensor, dim: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_repeat_interleave1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                repeats.c_tensor,
                dim
            ) });
    ...
    pub fn f_repeat_interleave2(
        &self, repeats: i64, dim: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_repeat_interleave2(c_tensors.as_mut_ptr(),
                self.c_tensor,
                repeats,
                dim
            ) });
    ...
    pub fn f_rrelu_with_noise_backward<S: Into<Scalar>>(
        &self, grad_output: &Tensor, noise: &Tensor, lower: S, upper: S, training: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_rrelu_with_noise_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
                noise.c_tensor,
                lower.into().c_scalar,
    ...
    pub fn f_rrelu_with_noise_backward_out<S: Into<Scalar>>(
        &self, grad_input: &Tensor, grad_output: &Tensor, noise: &Tensor, lower: S, upper: S, training: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_rrelu_with_noise_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                noise.c_tensor,
    ...
    pub fn f_s_copy_(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_s_copy_(c_tensors.as_mut_ptr(),
                self.c_tensor,
                src.c_tensor,
                if non_blocking { 1 } else { 0 }
            ) });
    ...
    pub fn f_scalar_tensor<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_scalar_tensor(c_tensors.as_mut_ptr(),
                s.into().c_scalar,
                options.0.c_int(), options.1.c_int()
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_scatter(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_scatter(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                src.c_tensor
    ...
    pub fn f_scatter1<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_scatter1(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                value.into().c_scalar
    ...
    pub fn f_scatter_add(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_scatter_add(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                index.c_tensor,
                src.c_tensor
    ...
    pub fn f_sigmoid_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_sigmoid_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                output.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_sigmoid_backward_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_sigmoid_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                output.c_tensor
            ) });
    ...
    pub fn f_softplus_backward<S: Into<Scalar>>(
        &self, grad_output: &Tensor, beta: S, threshold: S, output: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_softplus_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
                beta.into().c_scalar,
    ...
    pub fn f_softplus_backward_out<S: Into<Scalar>>(
        &self, grad_input: &Tensor, grad_output: &Tensor, beta: S, threshold: S, output: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_softplus_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                beta.into().c_scalar,
    ...
    pub fn f_softshrink_backward<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_softshrink_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                self.c_tensor,
                lambd.into().c_scalar
            ) });
    ...
    pub fn f_softshrink_backward_out<S: Into<Scalar>>(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_softshrink_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                self.c_tensor,
                lambd.into().c_scalar
    ...
    pub fn f_solve(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_solve(c_tensors.as_mut_ptr(),
                self.c_tensor,
                a.c_tensor
            ) });
        Ok((Tensor { c_tensor: c_tensors[0] }, Tensor { c_tensor: c_tensors[1] }))
    ...
    pub fn f_solve_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_solve_out(c_tensors.as_mut_ptr(),
                solution.c_tensor,
                lu.c_tensor,
                self.c_tensor,
                a.c_tensor
    ...
    pub fn f_sparse_resize_(
        &mut self, size: &[i64], sparse_dim: i64, dense_dim: i64
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_std_out(
        &self, out: &Tensor, dim: &[i64], unbiased: bool, keepdim: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
    ...
    pub fn f_sum_to_size(
        &self, size: &[i64]
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_sum_to_size(c_tensors.as_mut_ptr(),
                self.c_tensor,
                size.as_ptr(), size.len() as i32
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_tanh_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_tanh_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                output.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_tanh_backward_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_tanh_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                output.c_tensor
            ) });
    ...
    pub fn f_to_dense_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_to_dense_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_to_mkldnn(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_to_mkldnn(c_tensors.as_mut_ptr(),
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    }

    pub fn f_to_mkldnn_backward(
        &self, grad: &Tensor
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_to_mkldnn_backward(c_tensors.as_mut_ptr(),
                grad.c_tensor,
                self.c_tensor
            ) });
        Ok(Tensor { c_tensor: c_tensors[0] })
    ...
    pub fn f_triangular_solve(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_triangular_solve(c_tensors.as_mut_ptr(),
                self.c_tensor,
                a.c_tensor,
                if upper { 1 } else { 0 },
                if transpose { 1 } else { 0 },
    ...
    pub fn f_triangular_solve_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 2];
        unsafe_torch_err!({
            atg_triangular_solve_out(c_tensors.as_mut_ptr(),
                x.c_tensor,
                m.c_tensor,
                self.c_tensor,
                a.c_tensor,
    ...
    pub fn f_tril_indices(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_tril_indices(c_tensors.as_mut_ptr(),
                row,
                col,
                offset,
                options.0.c_int(), options.1.c_int()
    ...
    pub fn f_triu_indices(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_triu_indices(c_tensors.as_mut_ptr(),
                row,
                col,
                offset,
                options.0.c_int(), options.1.c_int()
    ...
    pub fn f_unique_consecutive(
        &self, return_inverse: bool, return_counts: bool, dim: i64
    ) -> failure::Fallible<(Tensor, Tensor, Tensor)> {
        let mut c_tensors = [std::ptr::null_mut(); 3];
        unsafe_torch_err!({
            atg_unique_consecutive(c_tensors.as_mut_ptr(),
                self.c_tensor,
                if return_inverse { 1 } else { 0 },
                if return_counts { 1 } else { 0 },
                dim
    ...
    pub fn f_unique_dim(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 3];
        unsafe_torch_err!({
            atg_unique_dim(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                if sorted { 1 } else { 0 },
                if return_inverse { 1 } else { 0 },
    ...
    pub fn f_unique_dim_consecutive(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 3];
        unsafe_torch_err!({
            atg_unique_dim_consecutive(c_tensors.as_mut_ptr(),
                self.c_tensor,
                dim,
                if return_inverse { 1 } else { 0 },
                if return_counts { 1 } else { 0 }
    ...
    pub fn f_upsample_bicubic2d(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_upsample_bicubic2d(c_tensors.as_mut_ptr(),
                self.c_tensor,
                output_size.as_ptr(), output_size.len() as i32,
    ...
    pub fn f_upsample_bicubic2d_backward(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_upsample_bicubic2d_backward(c_tensors.as_mut_ptr(),
                grad_output.c_tensor,
                output_size.as_ptr(), output_size.len() as i32,
                input_size.as_ptr(), input_size.len() as i32,
                if align_corners { 1 } else { 0 }
    ...
    pub fn f_upsample_bicubic2d_backward_out(
        ...
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_upsample_bicubic2d_backward_out(c_tensors.as_mut_ptr(),
                grad_input.c_tensor,
                grad_output.c_tensor,
                output_size.as_ptr(), output_size.len() as i32,
                input_size.as_ptr(), input_size.len() as i32,
    ...
    pub fn f_upsample_bicubic2d_out(
        &self, out: &Tensor, output_size: &[i64], align_corners: bool
    ) -> failure::Fallible<Tensor> {
        let mut c_tensors = [std::ptr::null_mut(); 1];
        unsafe_torch_err!({
            atg_upsample_bicubic2d_out(c_tensors.as_mut_ptr(),
                out.c_tensor,
                self.c_tensor,
                output_size.as_ptr(), output_size.len() as i32,
                if align_corners { 1 } else { 0 }
