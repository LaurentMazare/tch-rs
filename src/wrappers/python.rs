...
pub unsafe fn pyobject_check(pyobject: *mut C_pyobject) -> Result<bool, TchError> {
...
impl Tensor {
    ...
    pub fn pyobject_wrap(&self) -> Result<*mut C_pyobject, TchError> {
    ...
    /// # Safety
    /// Undefined behavior if the given pointer is not a valid PyObject.
    pub unsafe fn pyobject_unpack(pyobject: *mut C_pyobject) -> Result<Option<Self>, TchError> {
