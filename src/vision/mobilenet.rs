...
fn cbr(p: nn::Path, c_in: i64, c_out: i64, ks: i64, stride: i64, g: i64) -> impl ModuleT {
    ...
    nn::seq_t()
        .add(nn::conv2d(&p / "1", c_in, c_out, ks, conv2d))
        .add(nn::batch_norm2d(&p / "2", c_out, Default::default()))
...
fn inv(p: nn::Path, c_in: i64, c_out: i64, stride: i64, er: i64) -> impl ModuleT {
    ...
    conv = conv
        ...
        .add(nn::conv2d(&p / "2", c_hidden, c_out, 1, nn::no_bias()))
        .add(nn::batch_norm2d(&p / "3", c_out, Default::default()));
