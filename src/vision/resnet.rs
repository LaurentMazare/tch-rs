...
pub fn resnet18(p: &nn::Path, num_classes: i64) -> FuncT<'static, crate::Tensor, crate::Tensor> {
    resnet(p, Some(num_classes), 2, 2, 2, 2)
}

pub fn resnet18_no_final_layer(p: &nn::Path) -> FuncT<'static, crate::Tensor, crate::Tensor> {
...
pub fn resnet34(p: &nn::Path, num_classes: i64) -> FuncT<'static, crate::Tensor, crate::Tensor> {
    resnet(p, Some(num_classes), 3, 4, 6, 3)
}

pub fn resnet34_no_final_layer(p: &nn::Path) -> FuncT<'static, crate::Tensor, crate::Tensor> {
...
pub fn resnet50(p: &nn::Path, num_classes: i64) -> impl ModuleT<Input = Tensor, Output = Tensor> {
    bottleneck_resnet(p, Some(num_classes), 3, 4, 6, 3)
}

pub fn resnet50_no_final_layer(p: &nn::Path) -> impl ModuleT<Input = Tensor, Output = Tensor> {
    bottleneck_resnet(p, None, 3, 4, 6, 3)
}

pub fn resnet101(p: &nn::Path, num_classes: i64) -> impl ModuleT<Input = Tensor, Output = Tensor> {
    bottleneck_resnet(p, Some(num_classes), 3, 4, 23, 3)
}

pub fn resnet101_no_final_layer(p: &nn::Path) -> impl ModuleT<Input = Tensor, Output = Tensor> {
    bottleneck_resnet(p, None, 3, 4, 23, 3)
}

pub fn resnet152(p: &nn::Path, num_classes: i64) -> impl ModuleT<Input = Tensor, Output = Tensor> {
    bottleneck_resnet(p, Some(num_classes), 3, 8, 36, 3)
}

pub fn resnet150_no_final_layer(p: &nn::Path) -> impl ModuleT<Input = Tensor, Output = Tensor> {
