...
This example has now been moved in its own repo [diffusers-rs](https://github.com/LaurentMazare/diffusers-rs).
While this example code and readme will be kept around, new changes will be made in the separate repo.
